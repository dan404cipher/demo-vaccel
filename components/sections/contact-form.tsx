...
// //   return (
// //     <div className="flex flex-col mx-10 items-center justify-start gap-20 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 pb-20 md:pb-40 relative z-10 pt-20 md:pt-40">
// //       {/* Heading */}
...
// //           initial="hidden"
// //           animate={isHeadingInView ? "visible" : "hidden"}
// //           className="text-base sm:text-lg md:text-xl text-white/70 text-center max-w-md sm:max-w-xl md:max-w-2xl"
// //         >
...
// //         <div className="flex flex-col lg:flex-row items-start justify-start gap-10 lg:gap-20 w-full">
// //           {/* Form Section */}
// //           <motion.div
// //             variants={slideInFromRight(1)}
// //             initial="hidden"
// //             animate={isHeadingInView ? "visible" : "hidden"}
// //             className="p-4 sm:p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 shadow-xl w-full lg:w-[600px] max-w-full"
// //           >
...
// //             initial="hidden"
// //             animate={isHeadingInView ? "visible" : "hidden"}
// //             className="w-full lg:w-[700px] h-full flex flex-col justify-start items-start gap-6 sm:gap-8 mt-8 lg:mt-12"
// //           >
// //             <motion.div
// //               custom={0}
...
// //               initial="hidden"
// //               animate={isHeadingInView ? "visible" : "hidden"}
// //               className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500"
...
// //               initial="hidden"
// //               animate={isHeadingInView ? "visible" : "hidden"}
// //               className="text-sm sm:text-base md:text-lg text-white/50 italic"
// //               whileInView={floatingAnimation}
// //             >
...
// //               initial="hidden"
// //               animate={isHeadingInView ? "visible" : "hidden"}
// //               className="text-base sm:text-lg md:text-xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-500"
// //               whileInView={floatingAnimation}
// //             >
...
// //               initial="hidden"
// //               animate={isHeadingInView ? "visible" : "hidden"}
// //               className="text-sm sm:text-base md:text-lg text-white/40"
// //               whileInView={floatingAnimation}
// //             >
...
// //               initial="hidden"
// //               animate={isHeadingInView ? "visible" : "hidden"}
// //               className="text-lg sm:text-xl md:text-2xl font-semibold text-white/70"
// //               whileInView={floatingAnimation}
// //             >
...
// //           initial="hidden"
// //           animate={isHeadingInView ? "visible" : "hidden"}
// //           className="p-4 sm:p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 shadow-xl w-full flex flex-col items-center"
// //         > */}
// //           {/* <motion.h3
// //             custom={0}
// //             variants={formElementVariants}
...
// //             For Urgent Queries
// //           </motion.h3> */}
// //           {/* <div className="flex flex-col sm:flex-row gap-4 mb-6 sm:mb-8 justify-center w-full">
// //             <motion.button
// //               custom={1}
// //               variants={formElementVariants}
// //               initial="hidden"
...
// //               whileHover={{ scale: 1.02 }}
// //               whileTap={{ scale: 0.98 }}
// //               className="w-full sm:w-[200px] px-6 py-3 bg-gradient-to-r from-purple-500/90 to-cyan-500/90 text-white font-medium rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
// //             >
...
// //               whileHover={{ scale: 1.02 }}
// //               whileTap={{ scale: 0.98 }}
// //               className="w-full sm:w-[200px] px-6 py-3 bg-gradient-to-r from-green-500/90 to-emerald-500/90 text-white font-medium rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
// //             >
// //               <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
//   return (
//     <div className="flex flex-col mx-10 items-center justify-start gap-20 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 pb-20 md:pb-40 relative  pt-20 md:pt-40">
//       {/* Toast Notification */}
//           {toastMessage && (
//         <motion.div
...
//             duration: 0.5
//           }}
//           className="fixed top-20 right-4 z-[9999] bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-6 py-3 rounded-lg shadow-xl backdrop-blur-sm border border-white/20 hover:from-purple-600 hover:to-cyan-600 transition-all duration-300"
//         >
//           {toastMessage}
//         </motion.div>
//       )}
...
//                     onBlur={handleBlur}
//                     className={`px-4 py-3 rounded-lg bg-white/10 border text-white placeholder-gray-400 focus:outline-none transition-colors ${
...
//                   onChange={handleChange}
//                   onBlur={handleBlur}
//                   className={`px-4 py-3 rounded-lg bg-white/10 border text-white placeholder-gray-400 focus:outline-none transition-colors resize-none ${
